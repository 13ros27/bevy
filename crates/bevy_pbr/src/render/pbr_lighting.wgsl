...
fn lighting_input_from_pbr_input(pbr_input: PbrInput) -> LightingInput {
    let N = pbr_input.N;
    let V = pbr_input.V;
    ...
    lighting_input.F0_ = pbr_functions::calculate_F0(material.base_color.rgb, material.metallic, material.reflectance);
